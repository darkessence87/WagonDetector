...
Tests["unknown_pets"].events = {
    ...
    {1,"SPELL_AURA_APPLIED","Player-1603-0AF2B92","Another player",0x512,0x0,"Pet-0-3773-1861-25197-78116-010265753E","Элементаль воды",0x1114,0x0,210320,"Аура благочестия",0x2,"BUFF"},
    ...
    {4,"SPELL_CAST_SUCCESS","Pet-0-3773-1861-25197-78116-020265753E","Элементаль воды",0x1114,0x0,"Vehicle-0-3773-1861-25197-134546-00001D50B9","Enemy",0x10a48,0x0,31707,"Водяная стрела",0x10},
