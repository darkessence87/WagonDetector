...
WD_BUTTON_STATISTICS_RULES_MODULE = "Statistic rules config"
WD_BUTTON_GUILD_ROSTER_MODULE = "Guild roster"
WD_BUTTON_RAID_OVERVIEW_MODULE = "Raid overview"
...
WD_IMPORT_QUESTION = "This will override all existing rules for the encounter \"%s\". Do you want to proceed?"
...
WD_RULE_AURA_STACKS_ANY = "gaining more stacks%s of %s aura"
WD_RULE_CAST_START = "[%s] starts cast %s"
WD_RULE_CAST = "[%s] casted %s"
WD_RULE_CAST_INTERRUPT = "interrupt [%s]'s %s"
WD_RULE_DISPEL = "dispel/steal %s"
